  ...
  el.innerHTML = `
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-10 pt-8 pb-8 md:pt-20 md:pb-16">
      ...
      <div class="grid md:grid-cols-2 gap-6 md:gap-16 items-start">
        <!-- Imagen -->
        <div class="overflow-hidden rounded-2xl sm:rounded-3xl shadow-soft">
          <img src="${product.image_url}" alt="${product.name}" class="w-full block object-cover max-h-[420px] md:max-h-none" loading="eager" decoding="async" />
        </div>
        ...
        <div class="flex flex-col">
          ...
          <div class="mt-6 md:mt-8 border-t border-brand-caramel/15 pt-6 md:pt-8 flex gap-2 sm:gap-3">
            ...
            <button onclick="copyProductUrl(this)"
              class="copy-btn flex items-center justify-center px-3.5 sm:px-5 rounded-full border border-brand-caramel/40 text-brand-caramel text-sm font-medium btn-lift hover:border-brand-caramel whitespace-nowrap">
              <span class="copy-idle inline-flex items-center gap-1.5 sm:gap-2">
              ...
              <span class="copy-done inline-flex items-center gap-1.5 sm:gap-2">
