    ...
    <div class="max-w-6xl mx-auto px-6 lg:px-10 pt-16 pb-10 md:pt-20 md:pb-16">
      ...
      <div class="grid md:grid-cols-2 gap-10 md:gap-16 items-start">
        ...
        <div class="flex flex-col">
          ...
          <div class="mt-8 border-t border-brand-caramel/15 pt-8 flex gap-3">
            <a href="https://wa.me/50683376864?text=${waMsg}" target="_blank" rel="noopener"
               class="flex flex-1 items-center justify-center gap-3 rounded-full bg-brand-gold text-brand-cocoa font-medium py-4 text-base btn-lift">
